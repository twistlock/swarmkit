...
func (m *Manager) Run(parent context.Context) error {
	...
	baseControlAPI := controlapi.NewServer(m.raftNode.MemoryStore(), m.raftNode, m.config.SecurityConfig, m.caserver, m.config.PluginGetter, drivers.New(m.config.PluginGetter))
